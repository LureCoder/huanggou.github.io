...
$(document).ready(function () {
    // 加载 JSON 文件
    getVideoCardsByCardId('5070Ti', undefined);
});
...
function getVideoCardsByCardId(cardId, cardFilter){
    if('5070Ti' == cardId){
        get5070TiVideoCards('5070Ti');
    }
}
